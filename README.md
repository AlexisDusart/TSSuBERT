...
We provide samples of code to use the model in [Model repository](./Model), note you can find in this repository another example of code [advanced_architecture.py](./Model/advanced_architecture.py) given by [Sdccoding](https://github.com/Sdccoding). I thank him for his interest in our work.

## :world_map: Parts of this repository

* [Model](./Model): Contains the architecture of the model using TensorFlow as well as the transformers library, samples of code to use the model and trained weights of the model presented in the paper.
